...
class BxiExample(Node):
    ...
    def timer_callback(self):
        ...
        if self.step == 1:
            ...
            obs[0, env_cfg.env.num_commands:env_cfg.env.num_commands+env_cfg.env.num_actions] = (q - (cfg.robot_config.default_dof_pos*self.stand_height)) * env_cfg.normalization.obs_scales.dof_pos
