...
class BxiExample(Node):
    ...
    def init_models(self):
        ...
        self.dance_jixiewu = DanceMotionPolicyGravityIsaaclabV3(self.npz_file_dict["jixiewu"], self.onnx_file_dict["jixiewu"], start_frame=10, fixed_pos=True)#fixed policy
